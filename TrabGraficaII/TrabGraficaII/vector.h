...
public:
    /**
     * @brief Vector - Cria um objeto do tipo Vetor com os dados pré-definidos
    ...
    /**
     * @brief Vector - Cria um novo objeto do tipo Vetor copiando os dados de um já existente
     ...
     * @return Magnitude da distÃ¢ncia entre dois vetores
     */
